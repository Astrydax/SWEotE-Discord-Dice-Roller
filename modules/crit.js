var d100 = require("./misc.js").polyhedral;
...
function textCrit(total, bot, channelEmoji) {
  ...
  switch (true) {
      case (total < 5):
      textCrit = print('purple', bot, channelEmoji) + "Minor Nick: The target suffers 1 strain.";
      break;
    case (total >= 6 && total <= 10):
      textCrit = print('purple', bot, channelEmoji) + "Slowed Down: The target can only act during the last allied Initiative slot on his next turn.";
      break;
    case (total >= 11 && total <= 15):
      textCrit = print('purple', bot, channelEmoji) + "Sudden Jolt: The target drops whatever is in hand.";
      break;
    ...
    case (total >= 31 && total <= 35):
      textCrit = print('purple', bot, channelEmoji) + "Stunned: The target is staggered until the end of his next turn.";
      break;
    case (total >= 36 && total <= 40):
      textCrit = print('purple', bot, channelEmoji) + "Stinger: Increase difficulty of next check by one.";
      break;
    case (total >= 41 && total <= 45):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Bowled Over: The target is knocked prone and suffers 1 strain.";
      break;
    case (total >= 46 && total <= 50):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Head Ringer: The target increases the difficulty of all Intellect and Cunning Checks by one until the end of the encounter.";
      break;
    case (total >= 51 && total <= 55):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Fearsome Wound: The target increases the difficulty of all Presence and Willpower checks by one until the end of the encounter.";
      break;
    case (total >= 56 && total <= 60):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Agonizing Wound: The target increases the difficulty of all Brawn and Agility checks by one until the end of the encounter.";
      break;
    ...
    case (total >= 66 && total <= 70):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Scattered Senses: The target removes all " + print('black', bot, channelEmoji) + " from skill checks until end of encounter.";
      break;
    ...
    case (total >= 76 && total <= 80):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Overpowered: The target leaves himself open, and the attacker may immediately attempt another free attack against him, using the exact same pool as the original attack.";
      break;
    case (total >= 81 && total <= 85):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Winded: Until the end of the encounter, the target cannot voluntarily suffer strain to activate any abilities or gain additional maneuvers.";
      break;
    case (total >= 86 && total <= 90):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Compromised: Increase difficulty of all skill checks by one until the end of the encounter.";
      break;
    case (total >= 91 && total <= 95):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "At the Brink: The target suffers 1 strain each time he performs an action.";
      break;
    ...
    case (total >= 111 && total <= 115):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Temporarily Lame: Until this Critical Injury is healed, the target cannot perform more than one maneuver during his turn.";
      break;
    case (total >= 116 && total <= 120):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Blinded: The target can no longer see. Upgrade the difficulty of all checks twice. Upgrade the difficulty of Perception and Vigilance checks three times.";
      break;
    case (total >= 121 && total <= 125):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Knocked Senseless: The target is staggered for the remainder of the encounter.";
      break;
    ...
    case (total >= 141 && total <= 150):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "The End is Nigh: The target will die after the last Initiative slot during the next round.";
      break;
    case (total >= 151):
...
function textShipCrit(total, bot, channelEmoji) {
  ...
  switch (true) {
    case (total <= 9):
      textCrit = print('purple', bot, channelEmoji) + "Mechanical Stress: The ship or vehicle suffers one point of system strain.";
      break;
    case (total >= 10 && total <= 18):
      textCrit = print('purple', bot, channelEmoji) + "Jostled: A small explosion or impact rocks the vehicle. All crew members suffer one strain and are disoriented for one round.";
      break;
    case (total >= 19 && total <= 27):
      textCrit = print('purple', bot, channelEmoji) + "Losing Power to Shields: Decrease defense in affected defense zone by one until the Critical Hit is repaired. If the ship or vehicle has no defense, suffer one point of system strain.";
      break;
    ...
    case (total >= 55 && total <= 63):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Shields Failing: Reduce defense in all defense zones by one point until the Critical Hit is repaired. If the ship or vehicle has no defense, suffer two points of system strain.";
      break;
    ...
    case (total >= 73 && total <= 81):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Power Fluctuations: The ship or vehicle is beset by random power surges and outages. The pilot cannot voluntarily inflict system strain on the ship (to gain an extra starship maneuver, for example), until this Critical Hit is repaired.";
      break;
    ...
    case (total >= 91 && total <= 99):
      textCrit = print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + print('purple', bot, channelEmoji) + "Engine Damaged: The ship or vehicle’s maximum speed is reduced by one point, to a minimum of one, until the Critical Hit is repaired.";
      break;
